(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"이름\"/><Cell col=\"1\" text=\"학번\"/><Cell col=\"2\" text=\"과목명\"/><Cell col=\"3\" text=\"신청날짜\"/><Cell col=\"4\" text=\"출석여부\"/></Band><Band id=\"body\"><Cell text=\"bind:studentName\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:studentNo\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:lectureName\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:attDate\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:attStatus\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"ds_status\" combodatacol=\"attStatus\" combocodecol=\"attStatus\" textAlign=\"center\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
