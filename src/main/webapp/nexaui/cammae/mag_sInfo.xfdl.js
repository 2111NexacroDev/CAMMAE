(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"55\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"71\"/><Column size=\"80\"/><Column size=\"68\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"0\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"학과\"/><Cell col=\"2\" text=\"학번\"/><Cell col=\"3\" text=\"학과코드\"/><Cell col=\"4\" text=\"이름\"/><Cell col=\"5\" text=\"학년\"/><Cell col=\"6\" text=\"생년월일\"/><Cell col=\"7\" text=\"주소\"/><Cell col=\"8\" text=\"연락처\"/><Cell col=\"9\" text=\"이메일\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:chk\"/><Cell col=\"1\" text=\"bind:departmentName\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:studentNo\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:universityCode\" edittype=\"text\"/><Cell col=\"4\" text=\"bind:studentName\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"5\" text=\"bind:studentGrade\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:studentBirth\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"7\" text=\"bind:studentAddress\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"8\" text=\"bind:studentPhonenumber\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"9\" text=\"bind:studentEmail\" edittype=\"text\" textAlign=\"center\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
