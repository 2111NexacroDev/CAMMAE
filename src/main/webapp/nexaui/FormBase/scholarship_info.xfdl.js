(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid00","40","78","798","192",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_autofittype("col");
            obj.set_binddataset("ds_scholarship");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"scholarship_inno\"/><Cell col=\"1\" text=\"scholarship_avg_grade\"/><Cell col=\"2\" text=\"scholarship_year\"/><Cell col=\"3\" text=\"scholarship_term\"/><Cell col=\"4\" text=\"scholarship_status\"/><Cell col=\"5\" text=\"scholarship_amount\"/><Cell col=\"6\" text=\"scholarship_name\"/><Cell col=\"7\" text=\"scholarship_phonenumber\"/><Cell col=\"8\" text=\"scholarship_college\"/><Cell col=\"9\" text=\"scholarship_student_no\"/></Band><Band id=\"body\"><Cell text=\"bind:scholarship_inno\"/><Cell col=\"1\" text=\"bind:scholarship_avg_grade\"/><Cell col=\"2\" text=\"bind:scholarship_year\"/><Cell col=\"3\" text=\"bind:scholarship_term\"/><Cell col=\"4\" text=\"bind:scholarship_status\"/><Cell col=\"5\" text=\"bind:scholarship_amount\"/><Cell col=\"6\" text=\"bind:scholarship_name\"/><Cell col=\"7\" text=\"bind:scholarship_phonenumber\"/><Cell col=\"8\" text=\"bind:scholarship_college\"/><Cell col=\"9\" text=\"bind:scholarship_student_no\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
