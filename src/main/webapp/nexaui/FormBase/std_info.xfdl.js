(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("Edit00_00_00_00","400","173","116","35",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_textAlign("center");
            obj.set_readonly("true");
            obj.set_borderRadius("15px / 15px");
            ...
            obj = new Edit("Edit00_00_00_00_00","200","250","116","35",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_textAlign("center");
            obj.set_readonly("true");
            obj.set_borderRadius("15px / 15px");
            ...
            obj = new Edit("Edit00_00_00_00_00_00_00","410","246","116","35",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_textAlign("center");
            obj.set_borderRadius("15px / 15px");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_01_00","120","234","70","60",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("생년월일");
            obj.set_font("bold 16px/normal \"Gulim\"");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_01_00_00","330","237","70","60",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_text("전화번호");
            obj.set_font("bold 16px/normal \"Gulim\"");
            this.addChild(obj.name, obj);

            obj = new Static("Static00_00_00","340","160","60","60",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("학년");
            obj.set_font("bold 16px/normal \"Gulim\"");
            this.addChild(obj.name, obj);
