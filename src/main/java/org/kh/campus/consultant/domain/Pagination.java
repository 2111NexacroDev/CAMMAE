...
public class Pagination {
	public static PageInfo getPageInfo(int currentPage, int totalCount) {
		...
		boolean prev, next;
		// 23 /5 = 4.8 + 0.9 = 5.7 => 5
		maxPage = (int) ((double) totalCount / consultantLimit + 0.9);
		...
		pi = new PageInfo(currentPage, consultantLimit, naviLimit, startNavi, endNavi, totalCount, maxPage, prev, next);
		return pi;
	}
