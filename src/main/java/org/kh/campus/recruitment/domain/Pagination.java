...
public class Pagination {
	public static PageInfo getPageInfo(int currentPage, int totalCount) {
		...
		boolean prev, next;
		// 23 /5 = 4.8  + 0.9 = 5.7 => 5
		maxPage = (int)((double)totalCount/recruitmentLimit + 0.9);
		...
		String searchKey = "";
		String searchValue = "";
		pi = new PageInfo(currentPage, recruitmentLimit, 
				naviLimit, startNavi, endNavi, totalCount, maxPage, prev, next, searchKey, searchValue);
		return pi;
	}
