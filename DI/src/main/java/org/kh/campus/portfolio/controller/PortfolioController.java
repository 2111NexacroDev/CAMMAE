...
public class PortfolioController {
	...
	@RequestMapping(value="", method=RequestMethod.GET)
	public String portWriteView(Model model, @ModelAttribute Portfolio portfolio) {
		int result = pService.insertPort(portfolio);
		return null;
	}
	
	@RequestMapping(value="", method=RequestMethod.GET)
	public String portDetailView(Model model, @RequestParam("port_title")String port_title) {
		Portfolio portfolio = pService.printDetailPort(port_title);
		return null;
	}
	
	@RequestMapping(value="", method=RequestMethod.GET)
	public String portModifyView(Model model, @RequestParam("port_title")String port_title) {
		int result = pService.updatePort(port_title);
		return null;
	}
	
	@RequestMapping(value="", method=RequestMethod.GET)
	public String portDeleteView(Model model, @RequestParam("port_title")String port_title) {
		int result = pService.deletePort(port_title);
		return null;
	}
	...
	@RequestMapping(value="", method=RequestMethod.GET)
	public String portAdminDetailView(Model model, @RequestParam("port_title")String port_title) {
		Portfolio portfolio = pService.printAdminDetailPort(port_title);
		return null;
	}
}
